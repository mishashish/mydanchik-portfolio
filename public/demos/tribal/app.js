(() => {
  ...
  const DEFAULTS = {
    ...
    gallery: [
      { id: 'g1', src: './assets/work-1.svg', caption: 'Spine totem' },
      { id: 'g2', src: './assets/work-2.svg', caption: 'Shoulder band' },
      { id: 'g3', src: './assets/work-3.svg', caption: 'Forearm spear' },
    ...
    reviews: [
      {
        ...
        name: 'Марія',
        stars: 5,
        text: 'Тихо, чисто, лінія як лезо. Заживуло рівно.',
      ...
      },
      {
        ...
        name: 'Taras',
        stars: 5,
        text: 'Зробили трайбл під спину — сидить ідеально.',
      ...
      },
      {
        ...
        name: 'Olya',
        stars: 4,
        text: 'Довго чекала слот, але воно того варте.',
        at: Date.now() - 86400000 * 2,
        ok: true,
      },
    ],
  ...
  function renderPublic() {
    ...
    $('heroStats').innerHTML = `
      <div><b>${state.gallery.length}</b><span>works</span></div>
      <div><b>${state.reviews.filter((r) => r.ok).length}</b><span>reviews</span></div>
      <div><b>${state.stats.views}</b><span>views</span></div>
    `
  ...
  $('bannerAdd').onclick = () => {
    ...
    const src = pendingBannerImage || './assets/banner.svg'
